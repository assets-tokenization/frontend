...
import { Dialog, DialogTitle, DialogActions, DialogContent, Button, CircularProgress } from '@mui/material';
...
class SchemaFormModal extends React.Component {
    ...
    render() {
        const { t, open, onClose, title, schema, customControls, translateError, saveButtonText, clean, darkTheme } = this.props;
        ...
        return (
            <>
                ...
                <ConfirmDialog
                    ...
                    description={error ? (translateError ? translateError(error.message) : error.message) : null}
