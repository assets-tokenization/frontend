export default t => (error) => {
    ...
    switch (error.keyword) {
        ...
        case 'maximum':
        case 'minimum':
            out = t('MustBe', { cond: error.params.comparison + ' ' + error.params.limit });
            break;
        case 'false schema':
            out = t('InvalidSchema');
            break;
        ...
        case 'patternRequired':
            out = t('ShouldPatternRequired', { missingPattern: error.params.missingPattern });
            break;
        case 'propertyNames':
            out = t('InvalidPropertyName', { propertyName: error.params.propertyName });
            break;
        case 'required':
            out = t('ReqiredField');
            break;
        case 'uniqueItems':
            out = t('ShouldHaveUniqueElements', { i: error.params.i, j: error.params.j });
            break;
