...
const defaultPopupState = (rootDocument, stepName) => rootDocument && rootDocument.data && rootDocument.data[stepName] && rootDocument.data[stepName].chosenPopup;
...
const ArraiInArray = (props) => {
    ...
    const [chosenPopup, setchosenPopup] = React.useState(defaultPopupState(rootDocument, stepName) || {});
    ...
    const handleSaveNewPopup = ({
        ...
        actions.setValues(replaceEmptyArrayItems({
            rootPath,
        }));
    };
    ...
    return (
        ...
        >
            {dynamicData.map((mainElement, index) => {
                const rootPath = [stepName].concat(path).filter(p => p !== null && p !== undefined && p !== '').concat(index);
                ...
                return (
                    ...
                    >
                        <div className={classes.expandItemRow}>
                            ...
                            <IconButton onClick={() => toggleCollapseArray(index)} size="large">
                                    ...
                                    <div className={classes.content}>
...

                                        {
                                            chosenSchema ? (
                                                <>
                                                    {
                                                        ((value && value[index]) || []).map((arrayItemData, innerIndex) => (
                                                            <SchemaForm
                                                                rootDocument={rootDocument}
                                                                schema={chosenSchema}
                                                                ...
                                                                actions={
                                                                    {
                                                                        ...actions,
                                                                        setValues: (data) => handleEditPopup({
                                                                            data,
                                                                            rootPath,
                                                                            innerIndex
                                                                        })
                                                    ...
                                                    {
                                                        chosenPopup[index] === 'limited' && value[index].length > 0 ? null : (
                                                            <SchemaForm
                                                                isAddButton={true}
                                                                rootDocument={rootDocument}
                                                                schema={chosenSchema}
                                                                ...
                                                                actions={
                                                                    {
                                                                        ...actions,
                                                                        setValues: (data) => handleSaveNewPopup({
                                                                            data,
                                                                            index,
                                                                            rootPath
                                                                        })
