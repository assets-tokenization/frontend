...
class Modal extends React.Component {
  ...
  render = () => {
    const { hidden, required, error, disabled, noMargin, readOnly } = this.props;

    if (hidden) return null;

    return (
      <ElementContainer required={required} error={error} bottomSample={true} noMargin={noMargin}>
        <ContentLayout
          {...this.props}
          {...this.state}
        ...
        />
        <DialogWrapper {...this.props} {...this.state} handleClose={this.handleClose} />
      </ElementContainer>
    );
  };
}
