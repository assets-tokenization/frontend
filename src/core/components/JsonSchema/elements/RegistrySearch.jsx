...
const optionsToMenu = option => (option ? ({
    ...option,
    value: option.id,
...
const RegistrySearch = ({
    ...
    const { data, isFetching } = useQuery(text ? [keyId, text, RESULTS_LIMIT, OFFSET] : null, actions.registerSearch);
