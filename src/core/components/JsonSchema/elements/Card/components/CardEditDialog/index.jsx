...
import { Button, Dialog, DialogContent, DialogTitle, Toolbar, Typography } from '@mui/material';
...
const CardEditDialog = ({ recoverData, schema: { control, description, ...schema }, ...props }) => {
  const t = useTranslate('Elements');
  const classes = withStyles();

  const handleClose = React.useCallback(() => {
    if (diff(props.rootDocument.data, recoverData)) {
      objectPath.set(recoverData, [props.stepName].concat(props.path, 'open'), false);
  ...
  return (
    ...
    >
      ...
      <DialogContent className={classes.content}>
        ...
        />
        <Button color="primary" variant="contained" onClick={handleSave} className={classes.button}>
