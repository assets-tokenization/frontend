                ...
                <>
                    {
                        description && (
                            <Typography
                                variant="body1"
                                classes={{ body1: classes.description }}
                            >
                                {description}
                            </Typography>
                        )
                                ...
                                }
                                {
                                    ...
                                    : (
                                        <Button
                                            ...
                                            disabled={loading}
                                        >
                                            {loading && <CircularProgress size={24} className={classes.btnLoader}/>}
                        ...
                        inited && !paymentRequestData
                            ? (
                                <>
                                    ...
                                    <Typography className={classes.errorText} variant={'body2'}>{t('QRError')}</Typography>
                                </>
                            )
                        : null
                    }
