...
class CustomDataSelect extends React.Component {
    ...
    getPayloadObject = () => {
        ...
        const isPayloadFull = (Object.keys(payload) || {}).length === (Object.keys(reguestBody) || {}).length;
    ...
    getOptions = () => {
        ...
        const flatArray = (Object.values(options || {}) || []).reduce((acc, val) => acc.concat(val), []);
    ...
    asyncReguest = () => {
        ...
        processList.set('requestCustomData', async(path, body) => {
        ...
        return (
            ...
            >
                <Select
                    ...
                    options={options ? options.map(option => ({ ...option, value: option.id, label: option.name })) : []}
                />
            </ElementContainer>
        );
    }
