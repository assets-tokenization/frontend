...
const TimeSlots = (props) => {
  ...
  const timeValuesToday = timeList.filter(
    ({ day }) => moment(day, 'YYYY-MM-DD').format('DD.MM.YYYY') === dateSorceValue
  );
  ...
  return (
    ...
    >
      {timeList.length ? (
        <>
          {timeValuesToday.length ? (
            ...
            <>
              ...
              <Typography className={classes.heading}>{t('NoFreeSlots')}</Typography>
            </>
          )}
          ...
          {!timeValuesToday.length && timeValuesFuture.length ? (
            ...
            <>
              {timeValuesFuture.length ? (
                <>
                  <Button className={classes.expendButton} onClick={() => toggleOpened(!opened)}>
                    <Typography className={classes.expendHeading}>{t('FreeSlots')}</Typography>
        ...
        <>
          <Typography className={classes.icon}>{'🤷‍♂️'}</Typography>
          <Typography className={classes.heading}>{t('NoFreeSlotsAll')}</Typography>
        </>
      )}
    </ElementContainer>
  );
