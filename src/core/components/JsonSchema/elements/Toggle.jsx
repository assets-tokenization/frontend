...
class ToggleComponent extends React.Component {
  ...
  render = () => {
          ...
          <FormControlLabel
            ...
            control={
              <Switch
                ...
                {...(eyeIcon
                  ? {
                      checkedIcon: <VisibilityOffOutlinedIcon className={classes.iconSvgFill} />,
                      icon: <VisibilityOutlinedIcon className={classes.iconSvgFill} />
                    }
                  : {})}
              />
            }
    ...
    return (
      ...
      >
        {eyeIcon ? <Tooltip title={tooltipTitle}>{renderContent}</Tooltip> : <>{renderContent}</>}
      </ElementContainer>
    );
  };
}
