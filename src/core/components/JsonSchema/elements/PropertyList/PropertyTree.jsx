...
const PropertyItem = ({ path, active, setPath, property, propertyName }) => {
    ...
    const hasOwnProperties = property.properties && Object.keys(property.properties).length;
...
const PropertyTree = ({ path, active, setPath, properties = {} }) => Object.keys(properties).map(propertyName => (
    <PropertyItem
        key={propertyName}
        setPath={setPath}
