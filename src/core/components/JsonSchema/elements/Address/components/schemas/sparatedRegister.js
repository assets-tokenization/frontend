...
const defaultSchema = ({ stepName, withNamedObjects, recordsTree }) => {
  let atu = {};
  let streetControl = {};
    ...
    case false: {
      atu = {
        ...
        district: {
          ...
          listenedValuesForRequest: [`${stepName}.region`],
          indexedSort: {
            'sort[data.name]': 'asc'
          },
        ...
        city: {
          ...
          listenedValuesForRequest: [`${stepName}.region`, `${stepName}.district`],
          indexedSort: {
            'sort[data.type]': 'asc'
          },
      ...
      building: {
        ...
        properties: {
          ...
          korpus: {
            ...
            checkHidden:
              "(propertyData, pageObject, allStepsData) => (pageObject && pageObject.isPrivateHouse && pageObject.isPrivateHouse[0] === 'приватний будинок')"
          },
          index: {
            type: 'string',
            description: 'Індекс',
      ...
      apt: {
        ...
        properties: {
          ...
          index: {
            ...
            description: 'Індекс',
            checkRequired:
              "(value, pageObject) => !pageObject?.isPrivateHouse || pageObject?.isPrivateHouse[0] !== 'приватний будинок'",
            sample:
              "<div style='display: inline-flex; background: #FFF4D7; padding: 10px 15px 10px 15px'>Дізнатися свій індекс можна&nbsp;<a href='https://ukrposhta.ua/dovidka/indeksi/' target='_blank' style='color:#000000;'>тут</a></div></div>",
            checkValid: [
              {
