...
const Accordions = ({ properties, required, schema, readOnly, value, onChange, path, type, hidden, ...rest }) => Object.keys(properties).map((panelName) => {
        ...
        <Accordion key={panelName}>
            ...
            <AccordionDetails>
                <SchemaForm
                    ...
                    required={Array.isArray(schema.required) ? schema.required.includes(panelName) : schema.required}
                />
            </AccordionDetails>
        </Accordion>
    );
