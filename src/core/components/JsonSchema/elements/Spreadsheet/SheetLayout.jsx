...
const SheetLayout = ({ children, errors, className, classes, width, stepName, path, scrollRef, dataListRef, selecting, virtualizeRef, ...rest }) => {
    ...
    return (
        <div
            ...
            className={classNames(classes.scroll, { [classes.errored]: errors && errors.length })}
