...
class CheckboxGroup extends React.Component {
  ...
  isDisabled = (item) => {
    ...
    if (isDisabled && typeof isDisabled === 'string') {
      isDisabled =
        evaluate(isDisabled, value, rootDocument.data[steps[activeStep]], rootDocument.data) ===
        true;
  ...
  isHidden = (item) => {
    ...
    if (hidden && typeof hidden === 'string') {
      hidden =
        evaluate(hidden, value, rootDocument.data[steps[activeStep]], rootDocument.data) === true;
