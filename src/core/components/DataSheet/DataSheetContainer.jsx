...
const DataSheetContainer = ({ headerHeight, dataListHeight, height, children, data, virtualizeRef }) => {
    ...
    React.useEffect(() => {
        ...
        const newHeight = (typeof height === 'number') ? Math.min(bodyHeight + headerHeight + 1, height) : height;
