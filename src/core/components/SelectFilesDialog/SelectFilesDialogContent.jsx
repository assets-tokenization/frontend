    ...
    >
        ...
        helperText={
          <span>
            ...
            {itIsClaim && (
              <span>
                .&nbsp;
                <span className={classes.error}>{t('FILE_TITLE_HINT_DESCRIPTION')}</span>
              </span>
            )}
          </span>
        }
      ...
      {!file && (
        <Card className={classes.card} id={setId('card')}>
          <CardContent className={classes.cardContent} id={setId('card-content')}>
            {!busy && (
              <IconButton
            ...
            <Typography variant="h5" className={classes.heading} id={setId('file-name')}>
              {file.name}
            </Typography>
            <Typography variant="subtitle1" color="textSecondary" id={setId('file-size')}>
              {filesize(file.size)}
            </Typography>
          </CardContent>
        </Card>
