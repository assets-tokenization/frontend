...
class SelectFilesDialog extends React.Component {
    ...
    handleChange = ({target}) => this.setState({name: target.value, error: false, showEmptyNameError: false});
    ...
    uploadFile = async () => {
        ...
        this.setState({error: null, busy: true, openVerifiedDialog: false}, async () => {
            try {
                ...
                onUpload({attachId, fileLink: fileLink || link, name, fileName: file.name, size: file.size, mimeType: file.type});
