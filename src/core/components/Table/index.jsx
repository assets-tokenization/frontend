            ...
            >
              {checkbox && ownerList && (
                ...
                >
                  ...
                  {data.resharing && (
                    <Icon
                      className={cx(classes.icon, checked.includes(data.id) && classes.checkbox)}
                    >
                      supervisor_account
                    </Icon>
                  )}
              ...
              {tableFields.map((item) => (
                <TableCell
                  ...
                  title={
                    item.key === 'status' || item.key === 'state' || item.key === 'icon'
                      ? ''
          ...
          <TableRow id={setId('table-footer-row')}>
            {showPagination && (
              <TablePagination
                ...
                labelDisplayedRows={({ from, to }) => t(labelDisplayedRows, { from, to, total })}
