...
const DataTableFilterPresetBar = ({ t, classes, presets = [], filters = {}, actions, filterHandlers = {} }) => {
        ...
        <Toolbar disableGutters={true}>
            {presets.map((preset, index) => (
                <Chip
                    ...
                    onClick={index === activePreset ? undefined : () => actions.onFilterChange(preset.filters)}
            ...
            <AddNewPresetDialog
                ...
                handleAddPreset={(newPresetName) => {
                    setOpen(false);
                    actions.onFilterPresetAdd({ name: newPresetName, filters: allowedFilters });
                }}
            />
        </Toolbar>
    );
