...
class SignatureDetails extends React.Component {
    print = () => {
        ...
        if (signatures?.length) {
            const result = signatures.map(({ signer: { organizationName, commonName }, issuer, serial, signTime }) => {
            ...
            printJS({
                printable: result,
                properties: ['commonName', 'organizationName', 'signTime', 'issuer', 'serial', 'fileName', 'documentId'],
                type: 'json',
