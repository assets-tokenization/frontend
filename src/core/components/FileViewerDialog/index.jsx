...
const FileViewerDialog = ({ classes, open, onClose, extension, file, fileName, darkTheme }) => (
    <Dialog
        ...
        classes={
            {
                root: classes.dialog,
                paperFullWidth: !['pdf', 'xlsx', 'json', 'bpmn', 'png', 'jpeg', 'jpg', 'gif', 'bmp'].includes(extension) && classes.paperFullWidth
            }
        }
    >
        <div className={classes.pageWrapper}>
            ...
            >
                {
                    darkTheme ? <CloseIconDark className={classes.closeIconImg} /> : (
                        <img
                            src={CloseIcon}
                            alt="Close dialog"
