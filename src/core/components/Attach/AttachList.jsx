...
const styles = {...customInputStyle, ...tableStyle, ...claimListStyles, ...attachStyle};
...
class AttachList extends Component {
    ...
    changeCount = ({ target: { value } }) =>
        this.setState({start: 0, page: 0, count: value});
    ...
    render() {
        ...
        const attachSetId = index => elmentName => setId(`${index ? `${index + 1}-` : ''}${elmentName}`);
