...
export const mapStateToProps = ({ sourceName }) => state => state[sourceName];
...
export default endPoint => component => connect(mapStateToProps(endPoint), mapDispatchToProps(endPoint))(component);
