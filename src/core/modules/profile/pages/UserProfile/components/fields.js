const fields = ({ EmailInput, PhoneInput }) => ({
  isLegal: [
    { key: 'companyName', name: 'company_name', label: 'CompanyNameInputLabel', disabled: true },
    ...
    { key: 'address', label: 'LegalAddress', maxLength: 255, helperText: 'AddressHelper' }
  ],
  notIsLegal: [
    ...
    { key: 'isIndividualEntrepreneur', label: 'IndividualEntrepreneur' },
    { key: 'address', label: 'Address', maxLength: 255, helperText: 'AddressHelper' }
  ]
});
