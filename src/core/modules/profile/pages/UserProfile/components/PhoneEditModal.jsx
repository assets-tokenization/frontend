...
class PhoneEditModal extends React.Component {
    ...
    sendSMSCode = () => {
        ...
        return phone && promiseChain([
            () => actions.checkPhoneExists(phone),
            ({ isExist }) => (isExist ? Promise.reject(new Error(t('PhoneAlreadyExists'))) : Promise.resolve()),
    ...
    renderContent() {
        ...
        return (
            <Fragment>
                <DialogContentText id="text">{phoneWithoutConfirm ? '' : t('PhoneDialogText')}</DialogContentText>
                <FormControl
                    variant="standard"
                    fullWidth={true}
                    className={classes.formControl}
                    ...
                    id="input-wrap">
                    <StringElement
                        description={phoneWithoutConfirm ? t('PhoneInputLabelWithoutSMS') : t('PhoneInputLabel')}
                        value={phone}
                        error={error}
