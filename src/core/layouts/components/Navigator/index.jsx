...
class Navigator extends React.Component {
    ...
    render() {
        const { classes, location, location: { pathname }, handleDrawerToggle } = this.props;
        const categories = [].concat(...modules.map(module => module.navigation || [])).sort(prioritySort);
                                ...
                                <Fragment key={categoryKey}>
                                    {
                                        category.id ? (
                                            ...
                                            >
                                                {
                                                    childs.map((child, childKey) => (child.Component
