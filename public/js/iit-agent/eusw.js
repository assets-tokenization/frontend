...
var EU_SIGN_CP_IFACE_VERSION				= '1.3.74';
...
EndUserTransferableObject.makeTransferable(EndUserReference);
...
EUSignCP.prototype.IsDataInSignedDataAvailable = function(
	...
	if (typeof data != 'string') {
		data = this._base64Encode(data, onError);
		if (data == null)
			return;
	}
...
EUSignCP.prototype.CreateReference = function(name, data) {
	return new EndUserReference(name, data);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.ASiCGetASiCType = function(
	asicData, onSuccess, onError) {
	var params;

	if (typeof asicData == 'string') {
		asicData = this._base64Decode(asicData, onError);
		if (asicData == null)
			return;
	}

	params = this._funcMakeParams(
		[new EndUserByteArray(asicData)]);
...
EUSignCP.prototype.ASiCGetSignsCount = function(
	asicData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('ASiCGetSignsCount', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.ASiCGetSignerInfo = function(
	signIndex, asicData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('ASiCGetSignerInfo', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.ASiCGetSignTimeInfo = function(
	signIndex, asicData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('ASiCGetSignTimeInfo', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.ASiCGetSignReferences = function(
	signIndex, asicData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('ASiCGetSignReferences', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.ASiCGetReference = function(
	asicData, reference, onSuccess, onError) {
	var params;
	...
	params = this._funcMakeParams(
		[new EndUserByteArray(asicData), reference]);

	return this._funcCall('ASiCGetReference', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.ASiCSign = function(
	asicType, signType, signLevel, references,
	onSuccess, onError) {
	var params;
	...
	for (var i = 0; i < references.length; i++) {
		referencesNames.push(references[i].GetName());
		referencesData.push(
			new EndUserByteArray(references[i].GetData()));
	}

	params = this._funcMakeParams([
		asicType, signType, signLevel,
		referencesNames, referencesData]);

	return this._funcCall('ASiCSign', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.ASiCAppendSign = function(
	signLevel, referencesNames, asicData, onSuccess, onError) {
	var params;
	...
	params = this._funcMakeParams([
		signLevel, referencesNames, 
		new EndUserByteArray(asicData)]);

	return this._funcCall('ASiCAppendSign', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.ASiCVerify = function(
	signIndex, asicData, showSignerInfo, onSuccess, onError) {
	var params;
	var paramsArr = [];
	...
	paramsArr.push(signIndex);
	paramsArr.push(new EndUserByteArray(asicData));
	if (typeof showSignerInfo == 'boolean')
		paramsArr.push(showSignerInfo);
	else
		paramsArr.push(null);
	...
	return this._funcCall('ASiCVerify', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.CtxASiCSign = function(
	pkContext, signAlgo, asicType, signType, signLevel, references,
	onSuccess, onError) {
	var params;
	...
	params = this._funcMakeParams([
		pkContext, signAlgo, asicType, signType, signLevel,
		referencesNames, referencesData]);

	return this._funcCall('CtxASiCSign', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.CtxASiCAppendSign = function(
	pkContext, signAlgo, signLevel, referencesNames, asicData,
	onSuccess, onError) {
	var params;
	...
	params = this._funcMakeParams([
		pkContext, signAlgo, signLevel, referencesNames, 
		new EndUserByteArray(asicData)]);

	return this._funcCall('CtxASiCAppendSign', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.CtxASiCGetSignerInfo = function(
	context, signIndex, asicData, onSuccess, onError) {
	var params;
	...
	params = this._funcMakeParams([context, signIndex,
		new EndUserByteArray(asicData)]);

	return this._funcCall('CtxASiCGetSignerInfo', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.ASiCGetSignLevel = function(
	signIndex, asicData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('ASiCGetSignLevel', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.ASiCIsAllContentCovered = function(
	signIndex, asicData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('ASiCIsAllContentCovered', params,
		onSuccess, onError, null);
};

//================================================================================

EUSignCP.prototype.PDFGetSignType = function(
	signIndex, signedPDFData, onSuccess, onError) {
	var params;

	if (typeof signedPDFData == 'string') {
		signedPDFData = this._base64Decode(signedPDFData, onError);
		if (signedPDFData == null)
			return;
	}

	params = this._funcMakeParams([
		signIndex, new EndUserByteArray(signedPDFData)]);

	return this._funcCall('PDFGetSignType', params,
		onSuccess, onError, null);
};
...
EUSignCP.prototype.PDFGetSignsCount = function(
	signedPDFData, onSuccess, onError) {
	var params;
	...
	params = this._funcMakeParams(
		[new EndUserByteArray(signedPDFData)]);
...
EUSignCP.prototype.PDFGetSignerInfo = function(
	signIndex, signedPDFData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('PDFGetSignerInfo', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.PDFGetSignTimeInfo = function(
	signIndex, signedPDFData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('PDFGetSignTimeInfo', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.PDFSign = function(
	pdfData, signType, onSuccess, onError) {
	var params;

	params = this._funcMakeParams([
		new EndUserByteArray(pdfData), signType]);

	return this._funcCall('PDFSign', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.PDFVerify = function(
	signIndex, signedPDFData, showSignerInfo, onSuccess, onError) {
	var params;
	var paramsArr = [];
	...
	paramsArr.push(signIndex);
	paramsArr.push(new EndUserByteArray(signedPDFData));
	if (typeof showSignerInfo == 'boolean')
		paramsArr.push(showSignerInfo);
	else
		paramsArr.push(null);
	...
	return this._funcCall('PDFVerify', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.CtxPDFSign = function(
	pkContext, signAlgo, pdfData, signType, onSuccess, onError) {
	var params;

	params = this._funcMakeParams([
		pkContext, signAlgo, new EndUserByteArray(pdfData),
		signType]);

	return this._funcCall('CtxPDFSign', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.CtxPDFGetSignerInfo = function(
	context, signIndex, signedPDFData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('CtxPDFGetSignerInfo', params,
		onSuccess, onError, null);
};
...
EUSignCP.prototype.XAdESGetType = function(
	...
	if (typeof xadesData == 'string') {
		xadesData = this._base64Decode(xadesData, onError);
		if (xadesData == null)
			return;
	}

	params = this._funcMakeParams(
		[new EndUserByteArray(xadesData)]);
...
EUSignCP.prototype.XAdESGetSignsCount = function(
	xadesData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('XAdESGetSignsCount', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.XAdESGetSignLevel = function(
	signIndex, xadesData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('XAdESGetSignLevel', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.XAdESGetSignerInfo = function(
	signIndex, xadesData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('XAdESGetSignerInfo', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.XAdESGetSignTimeInfo = function(
	signIndex, xadesData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('XAdESGetSignTimeInfo', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.XAdESGetSignReferences = function(
	signIndex, xadesData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('XAdESGetSignReferences', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.XAdESGetReference = function(
	xadesData, reference, onSuccess, onError) {
	var params;
	...
	params = this._funcMakeParams(
		[new EndUserByteArray(xadesData), reference]);

	return this._funcCall('XAdESGetReference', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.XAdESSign = function(
	xadesType, signLevel, references, onSuccess, onError) {
	var params;
	...
	return this._funcCall('XAdESSign', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.XAdESVerify = function(
	references, signIndex, xadesData, showSignerInfo,
	onSuccess, onError) {
	var params;
	var paramsArr = [];

	var referencesNames = null;
	var referencesData = null;
	if (references != null) {
		referencesNames = [];
		referencesData = [];
		for (var i = 0; i < references.length; i++) {
	...
	paramsArr.push(referencesNames);
	paramsArr.push(referencesData);
	paramsArr.push(signIndex);
	paramsArr.push(new EndUserByteArray(xadesData));
	if (typeof showSignerInfo == 'boolean')
		paramsArr.push(showSignerInfo);
	else
		paramsArr.push(null);
	...
	return this._funcCall('XAdESVerify', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.CtxXAdESSign = function(
	pkContext, signAlgo, xadesType, signLevel, references,
	onSuccess, onError) {
	var params;
	...
	params = this._funcMakeParams([
		pkContext, signAlgo, xadesType, signLevel,
		referencesNames, referencesData]);

	return this._funcCall('CtxXAdESSign', params,
		onSuccess, onError, null);
};

//--------------------------------------------------------------------------------

EUSignCP.prototype.CtxXAdESGetSignerInfo = function(
	context, signIndex, xadesData, onSuccess, onError) {
	var params;
	...
	return this._funcCall('CtxXAdESGetSignerInfo', params,
		onSuccess, onError, null);
};
